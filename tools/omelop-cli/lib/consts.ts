export let consts = {
    ...
    WELCOME_INFO: ['\nWelcome to Omelop interactive client.',
        'Omelop is a fast, scalable game server framework for node.js. ',
        'Type \\\'help\\\' for more information.\n'
    ],

    HELP_INFO_1: [
        '\nFor information about Omelop products and services, visit:',
        '   https://omelop.io/',
        '\nList of all Omelop commands:\n'
    ],
    ...
    HELP_LOGIN: [
        '\nWelcome to Omelop interactive client.',
        'Omelop is a fast, scalable game server framework for node.js. ',
        'You can use following command to connect to omelop master',
        'omelop-cli -h host -P port -u user -p password',
        'Default type omelop-cli equals to:',
        'omelop-cli -h 127.0.0.1 -P 3005 -u admin -p admin\n'
    ],
    ...
    COMANDS_MAP: {
        ...
        'config': ['\nconfig infos like : proxy, remote, connection, connector, session',
            ...
            'in omelop you can pass opt config to component to make your like-style server',
    ...
    MODULE_INFO: 'there are following modules registered in omelop clusters',

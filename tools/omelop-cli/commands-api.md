...
- [use](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#use)  
- [quit](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#quit)  
- [kill](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#kill)  
- [exec](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#exec)  
- [get](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#get)  
- [set](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#set)  
- [add](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#add)  
- [stop](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#stop)  
- [show](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#show)  
- [enable](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#enable)  
- [disable](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#disable)  
- [dump](https://github.com/NetEase/omelop-cli/wiki/omelop-cli-man-page#dump)  
...
# Quit
type **quit** and you can quit omelop-cli  
...
filepath can be relative path to your omelop-cli pwd path  
```
example : exec xxx.js  
```

...
require.register("node-omelop-omelop-protocol/lib/protocol.js", function (exports, require, module) {
...
require.register("pinusnode-omelop-protobuf/lib/client/protobuf.js", function (exports, require, module) {
...
require.register("pinusnode-omelop-jsclient-websocket/lib/omelop-client.js", function (exports, require, module) {
  (function () {
    ...
    var root = window;
    var omelop = Object.create(EventEmitter.prototype); // object extend from object
    root.omelop = omelop;
    var socket = null;
    var reqId = 0;
    var callbacks = {};
    ...
    omelop.init = function (params, cb) {
      initCallback = cb;
    ...
    var initWebSocket = function (url, cb) {
      ...
      var onerror = function (event) {
        omelop.emit('io-error', event);
        console.error('socket error: ', event);
      };
      var onclose = function (event) {
        omelop.emit('close', event);
    ...
    omelop.request = function (route, msg, cb) {
    ...
    omelop.notify = function (route, msg) {
      msg = msg || {};
    ...
    var sendMessage = function (reqId, route, msg) {
      ...
      var protos = !!omelop.data.protos ? omelop.data.protos.client : {};
      if (!!protos[route]) {
      ...
      var compressRoute = 0;
      if (omelop.dict && omelop.dict[route]) {
        route = omelop.dict[route];
        compressRoute = 1;
      }
    ...
    var handshake = function (data) {
      ...
      if (data.code === RES_OLD_CLIENT) {
        omelop.emit('error', 'client version not fullfill');
        return;
      }

      if (data.code !== RES_OK) {
        omelop.emit('error', 'handshake fail');
        return;
      }
    ...
    var processMessage = function (omelop, msg) {
      if (!msg.id) {
        // server push message
        omelop.emit(msg.route, msg.body);
        return;
      }
    ...
    var processMessageBatch = function (omelop, msgs) {
      for (var i = 0, l = msgs.length; i < l; i++) {
        processMessage(omelop, msgs[i]);
      }
    };

    var deCompose = function (msg) {
      var protos = !!omelop.data.protos ? omelop.data.protos.server : {};
      var abbrs = omelop.data.abbrs;
      var route = msg.route;
    ...
    //Initilize data used in omelop client
    var initData = function (data) {
      if (!data || !data.sys) {
        return;
      }
      omelop.data = omelop.data || {};
      var dict = data.sys.dict;
      var protos = data.sys.protos;

      //Init compress dict
      if (dict) {
        omelop.data.dict = dict;
        omelop.data.abbrs = {};

        for (var route in dict) {
          omelop.data.abbrs[dict[route]] = route;
        }
      }
...
require.alias("boot/index.js", "omelop-client/deps/boot/index.js");
require.alias("component-emitter/index.js", "boot/deps/emitter/index.js");
require.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require.alias("node-omelop-omelop-protocol/lib/protocol.js", "boot/deps/omelop-protocol/lib/protocol.js");
require.alias("node-omelop-omelop-protocol/lib/protocol.js", "boot/deps/omelop-protocol/index.js");
require.alias("node-omelop-omelop-protocol/lib/protocol.js", "node-omelop-omelop-protocol/index.js");

require.alias("pinusnode-omelop-protobuf/lib/client/protobuf.js", "boot/deps/omelop-protobuf/lib/client/protobuf.js");
require.alias("pinusnode-omelop-protobuf/lib/client/protobuf.js", "boot/deps/omelop-protobuf/index.js");
require.alias("pinusnode-omelop-protobuf/lib/client/protobuf.js", "pinusnode-omelop-protobuf/index.js");

require.alias("pinusnode-omelop-jsclient-websocket/lib/omelop-client.js", "boot/deps/omelop-jsclient-websocket/lib/omelop-client.js");
require.alias("pinusnode-omelop-jsclient-websocket/lib/omelop-client.js", "boot/deps/omelop-jsclient-websocket/index.js");
require.alias("pinusnode-omelop-jsclient-websocket/lib/omelop-client.js", "pinusnode-omelop-jsclient-websocket/index.js");

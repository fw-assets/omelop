 ...
 *
 * Omelop Client for Egret, with protobuf support, with js ws client version 0.0.5
 * Github: https://github.com/govo/PinusForEgret.git
 *
 * Thanks to:
 * D-Deo @ https://github.com/D-Deo/omelop-flash-tcp.git
 * and yicaoyimu @ http://bbs.egret.com/forum.php?mod=viewthread&tid=2538&highlight=omelop
 */
...
export class WSClient {
    ...
    private initWebSocket(host, port, cb: Function): void {
        console.log('[Omelop] connect to:', host, port);
    ...
    private onConnect(): void {
        console.log('[Omelop] connect success');
    ...
    private onClose(e: any): void {
        console.error('[Omelop] connect close:', e);
        // this.emit(Omelop.EVENT_CLOSE,e);
    }

    private onIOError(e: any): void {
        // this.emit(Omelop.EVENT_IO_ERROR, e);
    ...
    private _disconnect(): void {
        console.warn('[Omelop] client disconnect ...');

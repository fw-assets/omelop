...
import { Application, IComponent, manualReloadCrons, manualReloadHandlers, manualReloadRemoters } from "omelop";
...
export class NestComponent implements IComponent {
    ...
    private async bootstrap() {
        ...
        switch (servertype) {
            ...
            default:
                console.warn(' unknow  omelop server type . no nestModule::', servertype);
                return null
        }

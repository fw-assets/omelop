[![Build Status](https://travis-ci.org/node-omelop/omelop-rpc.svg?branch=master)](https://travis-ci.org/node-omelop/omelop-rpc)

#omelop-rpc - rpc framework for omelop

omelop-rpc is the low level RPC framework for omelop project. It contains two parts: client and server.
...
And the remote service codes would loaded by omelop-loader module and more details please access this [link](https://github.com/fw-assets/omelop-loader).

+ Tags: node.js

##Installation
```
npm install omelop-rpc
```

##Usage
###Server
``` javascript
var Server = require('omelop-rpc').server;
...
###Client
``` javascript
var Client = require('omelop-rpc').client;

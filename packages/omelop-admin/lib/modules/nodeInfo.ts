/*!
 * Omelop -- consoleModule nodeInfo processInfo
 * Copyright(c) 2012 fantasyni <fantasyni@163.com>
 * MIT Licensed
 */
import * as monitor from 'omelop-monitor';
import { getLogger } from 'omelop-logger'; import { IModule, ModuleType, MonitorCallback, MasterCallback } from '../consoleService';
import { MonitorAgent } from '../monitor/monitorAgent';
import { MasterAgent } from '../master/masterAgent';
import { PsParam } from 'omelop-monitor';
import * as path from 'path';
let logger = getLogger('omelop-admin', path.basename(__filename));

...
import { createServer, Gateway, RpcServerOpts, Remoters, Remoter, RemoteServerCode } from 'omelop-rpc';
...
export interface RemoteComponentOptions extends RpcServerOpts {
    ...
    /**
     * convert remote path to relative path (need to upgrade omelop-loader to a supported version)

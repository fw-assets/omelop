/*!
 * Omelop -- consoleModule serverStop stop/kill
...
import { IModule, MonitorCallback, MasterAgent, MasterCallback } from 'omelop-admin';
import { MonitorAgent } from 'omelop-admin';

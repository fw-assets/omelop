  ...
  omelop.init = function (params, cb) {
    ...
    socket.on('message', function (data) {
      ...
      if (data instanceof Array) {
        processMessageBatch(omelop, data);
      } else {
        processMessage(omelop, data);
      }
    });
    ...
    function processCall(msg) {
      ...
      if (!!route) {
        if (!!msg.body) {
          ...
          omelop.emit(route, body);
        } else {
          omelop.emit(route, msg);
        }
      } else {
        omelop.emit(msg.body.route, msg.body);
      }
    }
  };

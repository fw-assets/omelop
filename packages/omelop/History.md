2.2.5 / 2017-1-22
=================
  * [#815](https://github.com/NetEase/omelop/pull/815)
  * [#901](https://github.com/NetEase/omelop/pull/901)

2.2.4 / 2017-1-20
=================
  * [NEW] upgrade omelop-rpc to 1.0.7
...
2.2.2 / 2017-1-20
=================
  * [#899](https://github.com/NetEase/omelop/pull/899)
...
2.2.0 / 2017-1-19
=================
  * [NEW] upgrade omelop-rpc to 1.0.6, rpc protocol moved to MQTT
  * [NEW] upgrade omelop-admin to 1.0.0
  * [NEW] pure javaScript without need to install c++ addons 

1.2.1 / 2015-12-31
================
  * [NEW] upgrade ws to 0.8.0
  * [#771](https://github.com/NetEase/omelop/pull/771)
  * [#774](https://github.com/NetEase/omelop/pull/774)
  * [FIX] tls: destory connection when clientError

1.2.0 / 2015-09-18
=================
  * [NEW] upgrade omelop-admin to 0.4.5
  * [#751](https://github.com/NetEase/omelop/pull/751)
  * [#741](https://github.com/NetEase/omelop/pull/741)
  * [#740](https://github.com/NetEase/omelop/pull/740)
  * [FIX] fix wrong variable in protobuf

1.1.9 / 2015-06-05
=================
  * [NEW] upgrade omelop-rpc to 0.4.10
  * [NEW] upgrade omelop-admin to 0.4.4
  * [NEW] upgrade omelop-logger to 0.1.7

1.1.8 / 2015-05-29
=================
  * fix bug on verison calculating when update proto files
  * avoid modules loading error on windows
  * [NEW] upgrade omelop-protocol to 0.1.6

1.1.7 / 2015-05-12
=================
  * [#706](https://github.com/NetEase/omelop/pull/706)
  * [#707](https://github.com/NetEase/omelop/pull/707)
  * [#443](https://github.com/NetEase/omelop/pull/443)
  * [#444](https://github.com/NetEase/omelop/pull/444)
  * [#713](https://github.com/NetEase/omelop/pull/713)
  * [NEW] upgrade omelop-rpc to 0.4.9
  * [NEW] upgrade omelop-admin to 0.4.3
...
0.7.7 / 2013-12-16
=================
* upgrade omelop-loader to 0.0.6
* upgrade omelop-logger to 0.1.2(add dynamic change logger level feature)

0.7.6 / 2013-12-3
=================
* upgrade omelop-rpc to 0.2.4
* upgrade omelop-admin to 0.2.6(fix reconnect bug)
...
* add masterha for omelop stop&list
* fix auto-restart disconnect bug
* update omelop start for different envs
...
* global filter
* transaction
* omelop-cli auto-complete
* some components rename

0.6.8 / 2013-11-4
=================
* update omelop-admin version
...
* upgrade omelop-admin to 0.2.4
* upgrade omelop-monitor to 0.3.7
* upgrade omelop-rpc to 0.2.2

[![Build Status](https://travis-ci.org/node-omelop/omelop-scheduler.svg?branch=master)](https://travis-ci.org/node-omelop/omelop-scheduler)

# omelop-scheduler
omelop-schedule is a schedule tool for nodejs, it's purpose is to provide a product level schedule module which is high efficient and can support large number job schedule.You can 
...
###Special characters
Omelop-schedule allow three kinds of spechial characters, they are '-', '/' and '.'.

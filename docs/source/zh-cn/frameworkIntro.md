...
### 一个典型的多进程MMO运行架构， 如下图所示：
 ...
 ![MMO运行架构](http://omelop.netease.com/resource/documentImage/mmoArchitecture.png)
...
omelop framework的组成架构如图所示：


 ![pinus框架](http://omelop.netease.com/resource/documentImage/omelop-arch.png)
...
应用的扩展性很重要， omelop framework支持以component的形式插入任何第三方组件, 也支持加入自定义的路由规则， 自定义的filter等。
...
![服务器抽象](http://omelop.netease.com/resource/documentImage/serverAbstraction.png)
...
以下是示例图：
![目录结构](http://omelop.netease.com/resource/documentImage/directory.png)
...
![请求示例](http://omelop.netease.com/resource/documentImage/request.png)
...
Pinus的框架里还实现了request的filter机制，广播/组播机制，详细介绍见[pinus框架参考](https://github.com/fw-assets/omelop/wiki/Omelop-Framework)。
...
![rpc调用](http://omelop.netease.com/resource/documentImage/rpcInterface.png)
...
component在[pinus框架参考](https://github.com/fw-assets/omelop/wiki/Omelop-Framework)将有更深入的讨论。
以下是component的生命周期图：

![components](http://omelop.netease.com/resource/documentImage/components.png)
